...
def pluspunkte():
    ...
    # Load saved data (with error handling for missing tables)
    saved_data = {}
    try:
        ...
        logging.error(f"Error loading saved pluspunkte data: {e}")
        # Initialize empty saved_data if tables don't exist yet
        for subject in subjects:
